...
<form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
	<!--begin::Heading-->
	<h3 class="fw-bold text-gray-900 mb-7">{{ __('Advanced Search') }}</h3>
	<!--end::Heading-->
	<!--begin::Input group-->
	<div class="mb-5">
	...
	<div class="d-flex justify-content-end">
		<button type="reset" class="btn btn-sm btn-light fw-bolder btn-active-light-primary me-2" data-kt-search-element="advanced-options-form-cancel">{{ __('Cancel') }}</button>
		<a href="#" class="btn btn-sm fw-bolder btn-primary" data-kt-search-element="advanced-options-form-search">{{ __('Search') }}</a>
	</div>
	<!--end::Actions-->
</form>
<!--end::Preferences-->
