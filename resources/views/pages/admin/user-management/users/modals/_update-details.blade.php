                    ...
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_update_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_user_header" data-kt-scroll-wrappers="#kt_modal_update_user_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div id="kt_modal_update_user_user_info" class="collapse show">
                            ...
                            <div class="fv-row mb-15">
                                ...
                                <select name="language" aria-label="{{ __('Select a Language') }}" data-control="select2" data-placeholder="{{ __('Select a Language...') }}" class="form-select form-select-solid" data-dropdown-parent="#kt_modal_update_details">
                                    <option></option>
                        ...
                        <div id="kt_modal_update_user_address" class="collapse show">
                            ...
                            <div class="d-flex flex-column mb-7 fv-row">
                                ...
                                <select name="country" aria-label="{{ __('Select a Country') }}" data-control="select2" data-placeholder="{{ __('Select a Country...') }}" class="form-select form-select-solid" data-dropdown-parent="#kt_modal_update_details">
