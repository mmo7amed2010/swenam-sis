...
mix.js('resources/js/forms/question-management.js', 'public/js/forms')
    ...
    .js('resources/js/components/QuestionEditor.js', 'public/js/components')
    .js('resources/js/components/ConditionalFields.js', 'public/js/components')
    .sourceMaps(!mix.inProduction());
